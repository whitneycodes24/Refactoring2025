...
public class EmployeeDatabase {
	...
	//add a new employee
	public void addEmployee(int id, String pps, String surname, String firstName,char gender, String department, double salary, boolean fullTime) {
		Employee employee = EmployeeFactory.createEmployee(id,  pps, surname, firstName, gender, department, salary, fullTime);
		employees.add(employee);
	}
	
	
	//find employee by id
	public Employee findByEmployeeById(int id) {
